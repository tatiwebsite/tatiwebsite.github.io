	...
	<header class="header bg-center" id="header">
		<div class="wrapper">
			<div class="header__bread-crumbs bread-crumbs">
				...
				<a href="uslugi_magazini.php" class="bread-crumbs__link --active">Услуги для интернет-магазинов</a>

			</div>
			<div class="header__inner --in-center">
				<h1 class="header__title">
					Комплекс логистических услуг для интернет-магазинов
				</h1>
				<p class="header__suboffer g-subtitle-small narrow with-arrow">
					Сохраним температуру от -18 С° до +4 С° на пути перевозки и хранения 
				</p>
			...
			<div class="cf__row">
				<div class="cf__item">
					<div class="cf__col-text">
						<div class="cf__text">
							<h3 class="cf__text-title">Организуем хранение вашей продукции на своих складах или заберем прямо с производства</h3>
							<p class="cf__text-descr">Предоставим на складе необходимое количество места, от 1 паллет-места до нескольких тысяч квадратных метров</p>
						</div>
						<ul class="cf__list">
							<li class="cf__list-item">
								<div class="cf__list-img">
									<img src="svg/list-house.svg" alt="icon" class="cf__icon">
								</div>
								<p class="cf__list-text">
									Собственные склады с сохранением температуры площадью более 1 500 м2 в&nbsp;каждом городе присутствия
								</p>
							</li>
							<li class="cf__list-item">
								<div class="cf__list-img">
									<img src="svg/list-car.svg" alt="icon" class="cf__icon">
								</div>
								<p class="cf__list-text">
									Готовы забирать продукцию прямо с вашего производства своим транспортом
								</p>
							</li>
							<li class="cf__list-item">
								<div class="cf__list-img">
									<img src="svg/list-cubic.svg" alt="icon" class="cf__icon">
								</div>
								<p class="cf__list-text">
									При необходимости промаркируем продукцию
								</p>
							</li>
						</ul>
					</div>
					<div class="cf__col-photo">
						<picture>
							<source srcset="img/uslugi/magazini-cf1.webp" type="image/webp">
							<img data-src="img/uslugi/magazini-cf1.jpg" alt="Организуем хранение">
						</picture>
					</div>
				</div>
	...
	<section class="dark-features">
		<div class="wrapper">
			<h2 class="dark-features__title g-title">
				Вы сможете освободить время, ресурсы <br> и кадры для развития и масштабирования компании
			</h2>
			<div class="dark-features__subtitle g-subtitle-big">
				За счет полного делегирования логистических <br> и&nbspскладских процессов
			</div>
			<div class="dark-features__title-big g-title-big">
				Комплекс услуг с «REFGO» позволяет:
			</div>
			<div class="dark-features__inner">
				<div class="dark-features__item">
					<div class="dark-features__item-content">
						<div class="dark-features__icon">
							<img src="svg/uslugi/dark-feature-zatrati.svg" alt="Сократить операционные затраты">
						</div>
						<div class="dark-features__descr">
							Сократить <br> операционные затраты
						</div>
					</div>
				</div>
				<div class="dark-features__item">
					<div class="dark-features__item-content">
						<div class="dark-features__icon">
							<img src="svg/uslugi/dark-feature--time.svg" alt="Ускорить обработку заказов">
						</div>
						<div class="dark-features__descr">
							Ускорить обработку <br> заказов
						</div>
					</div>
				</div>
				<div class="dark-features__item">
					<div class="dark-features__item-content">
						<div class="dark-features__icon">
							<img src="svg/uslugi/dark-feature-value.svg" alt="Увеличить объемы продаж">
						</div>
						<div class="dark-features__descr">
							Увеличить объемы продаж и&nbsp;быть спокойным за логистику
						</div>
					</div>
				</div>
				<div class="dark-features__item">
					<div class="dark-features__item-content">
						<div class="dark-features__icon">
							<img src="svg/uslugi/dark-feature-graph.svg" alt="Быть готовым к сезонным скачкам и падениям в продажах">
						</div>
						<div class="dark-features__descr">
							Быть готовым к сезонным скачкам и падениям в продажах
						</div>
					</div>
				</div>
			</div>
