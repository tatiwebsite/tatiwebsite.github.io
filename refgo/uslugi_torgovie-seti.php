...
<body>
	...
	<header class="header bg-center" id="header">
		<div class="wrapper">
			<div class="header__bread-crumbs bread-crumbs">
				...
				<a href="uslugi_magazini.php" class="bread-crumbs__link --active">Доставка в торговые сети</a>

			</div>
			<div class="header__inner --in-center">
				<h1 class="header__title">
					Доставка продуктов питания в торговые сети рефрижератором
				</h1>
	...
	<section class="clients mt-80" id="clients">
		<div class="wrapper">
			<h2 class="clients__title g-title">
			   Мы умеем правильно работать с торговыми сетями 
			</h2>
		...
		<div class="wrapper">
			...
			<div class="dark-features__inner">
				<div class="dark-features__col">
					...
					<div class="dark-features__item">
						<div class="dark-features__header">
							...
							<h3 class="dark-features__subtitle">
								Перевозка в&nbsp;температурном режиме
							</h3>
						</div>
						<p class="dark-features__text">
				...
				<div class="dark-features__photo">
					<picture>
						<source srcset="img/uslugi/dark/dark-big1.webp" type="image/webp">
						<img data-src="img/uslugi/dark/dark-big1.png" alt="Перевозка в температурном режиме">
					</picture>
				</div>
			</div>
		</div>
